...
class Batcher(object):
    ...
    def pair_generator(self, example_generator):
        while True:
            ...
            try:
                article_text = e.features.feature['source_txt'].bytes_list.value[0]  # the article text was saved under the key 'article' in the data files
                abstract_text = e.features.feature['target_txt'].bytes_list.value[0]  # the abstract text was saved under the key 'abstract' in the data files
            except ValueError:
